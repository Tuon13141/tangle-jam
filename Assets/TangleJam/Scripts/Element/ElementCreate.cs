...
namespace Tuon
{
    public class ElementCreate : MonoBehaviour
    {
        ...
        public void CoilDouble()
        {
            ...
            Color color = FindObjectOfType<LevelCreate>().pictureAsset.Colors[value];
            CoilElement coilElement = Static.InstantiateUtility(m_PrefabManager.GetCoilPrefab(), gridElement.holder);
