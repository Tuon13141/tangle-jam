...
namespace Sonat
{
    ...
    public class SonatLogBuyShopItemIapInput
    {
        ...
        public SonatLogBuyShopItemIapInput(){}
    ...
    public class SonatLogStartFeature : SonatLogBasicMode
    {
        ...
        {
            var parameters = base.BaseLogs();
            parameters.Add(new Sonat.LogParameter(ParameterEnum.level.ToString(), level));
            parameters.Add(new Sonat.LogParameter(ParameterEnum.start_count.ToString(), start_count));
            return parameters;
        }
    }
    ...
    public class SonatLogEndFeature : SonatLogBasicMode
    {
        ...
        protected override List<Sonat.LogParameter> GetParameters()
        {
            ...
            parameters.Add(new Sonat.LogParameter(ParameterEnum.level.ToString(), level));
            parameters.Add(new Sonat.LogParameter(ParameterEnum.start_count.ToString(), start_count));
            parameters.Add(new Sonat.LogParameter(ParameterEnum.success.ToString(), success.ToString()));
            return parameters;
        }
    }
    ...
    [Serializable]
    public class SonatLogAdsState : BaseSonatAnalyticLog
    {
		...
		public override void Post(bool logAf = false, int debugLog = 0)
		{
            if (RemoteConfigKey.log_ads_state.GetValueBoolean(false))
                base.Post(logAf, debugLog);
		}
	}

    [Serializable]
    public class SonatLogAdDuration : BaseSonatAnalyticLog
    {
        string format;
        string adSource;
        string adValue;
        ...
        protected override List<LogParameter> GetParameters()
        {
            ...
            parameters.Add(new LogParameter("medationPlatform", medationPlatform));
            return parameters;
        }
    }
