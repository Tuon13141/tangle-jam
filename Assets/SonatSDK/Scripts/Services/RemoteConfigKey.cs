...
public enum RemoteConfigKey
{
    ...
    admob_open_ad_id = 24,
    admob_collapsible_ad_id = 41,
    admob_native_ad_id = 42,
    ...
    level_start_show_on_focus_ads = 60,
    ads_on_focus_time_gap = 61,
    by_level_condition_ads_on_focus_time_gap = 62,
    by_level_condition_inter_common_time_gap = 63,
    by_level_condition_inter_rw_time_gap = 64,
    by_level_condition_ads_ingame_time_gap = 65,
    ...
    by_level_condition_admob_collapsible_id = 156,
    by_level_condition_admob_nativeads_id = 157,
    //
    ...
    by_level_condition_max_merec_id = 170,
    ...
    pam_admob_collapsible_id = 176,
    pam_admob_nativeads_id = 177,
    ...
    remote_level_data_internal_testing = 325,
    log_ads_state = 326,
    show_interstitial_first_no_ads = 327,

    force_update = 420,
    campaign_segment = 421,
    payer_segment = 422
}
