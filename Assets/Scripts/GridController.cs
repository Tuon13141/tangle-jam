...
public class GridController : MonoBehaviour
{
    ...
    public void Setup(LevelAsset levelData, int stageIndex)
    {
    ...
    void Start()
    {
        ...
        if (LevelController.instance.currentStage == this && stageData.tutorialType != LevelAsset.TutorialType.None)
        {
    ...
    {
        //check data
        if (levelData.Stages.Length < stageIndex)
        {
        ...
        //get data
        stageData = levelData.Stages[stageIndex - 1];
